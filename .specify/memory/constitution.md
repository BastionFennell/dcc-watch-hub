...
- The active feature spec (`.specify/feature.json` → `specs/<feature>/spec.md`) defines scope.
  ...
  wired, even "for later." As of 2026-09-16 the active feature is 007 (`specs/007-npc-registry`): NPC encounters on the
  episode page and the System Registry glossary. v1, v2, 003, 004, 005, and 006 are merged. Still parked: stinger sounds, roster page,
