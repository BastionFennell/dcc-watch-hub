<!-- SPECKIT START -->
Active feature: `specs/006-mobile-pass/` (branch `006-mobile-pass`); v1, v2, 003, 004, and 005 are merged
on `main` and documented under `specs/00[1-5]-*/`.
Read, in order: `.specify/memory/constitution.md`, then `spec.md`, `plan.md`, `research.md`,
`contracts/`, `quickstart.md`, `tasks.md` under `specs/006-mobile-pass/`.
...
the active feature scope (006: mobile pass — no tooltips, stingers, roster, or v3);
